  ...
  return (
    <div className="min-h-screen bg-paper">
      ...
      <main className="mx-auto max-w-[1000px] px-5 py-10 sm:px-11">
        ...
        {state === 'ready' && listing && (
          // Two real columns: the sticky summary lives in its OWN column so it
          // can't travel down over the description/amenities (which sit in the
          // left column, not spanning under the sidebar).
          <div className="grid gap-8 lg:grid-cols-[1.4fr_1fr] lg:items-start">
            {/* Left column: gallery + description + amenities */}
              ...
              <div>
                <div className="relative aspect-[4/3] overflow-hidden rounded-2xl bg-track">
                  ...
                  <button
                    ...
                    title={t('favAria')}
                    className="absolute right-4 top-4 flex h-9 w-9 items-center justify-center rounded-full bg-black/40 backdrop-blur-sm transition hover:bg-black/55"
                  >
                    <Heart size={18} className={cn(fav ? 'fill-terracotta text-terracotta' : 'text-white')} />
                  </button>
                </div>
